...
<!--
version: 1.0.0
sync-source: skills/novel-deslop/references/anti-ai-writing.md
origin: 从 story-deslop/references/anti-ai-writing.md 同步
...
| 情感/心理 | 20-40 字 | 她站在窗前，看着外面的雨，想起那年夏天他撑着伞走过来的样子，嘴角不自觉地弯了一下。 |

**长短句结合示例**：

❌ **错误：全是短句**
```
她想。她居然获得了提名。英国电影学院奖。最佳编剧。她不敢相信。她掐了自己一下。疼。是真的。
```

✅ **正确：长短句结合**
```
她想，她居然获得了英国电影学院奖最佳编剧的提名。
这不可能。她掐了自己一下，疼。
窗外的雨还在下，她盯着手机屏幕上的邮件看了三遍，才敢相信这是真的。
```

**节奏控制技巧**：

1. **短句制造紧张**：连续短句用于打斗、冲突、紧张场景
2. **长句营造氛围**：长句用于描写、情感、回忆场景
3. **长短交错**：不要连续5句以上都是短句或长句
4. **关键信息用短句**：重要转折、情感冲击用短句强调
5. **铺垫用长句**：背景介绍、环境描写用长句展开
...
> 核心原则：长短句交错，不要连续5句以上都是短句或长句。一个段落2-4个句子，根据内容自然分段。
